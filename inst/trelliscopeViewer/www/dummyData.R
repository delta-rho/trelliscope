...
a <- list(
   "panel-layout" = list(
      ...
      update_button = "panelLayoutUpdateButton"
   ),
   "panel-function" = list(
   ...
   "add-related-display" = list(
      ...
      panel_header = "Add Related Display",
   ...
   "cog-table-sort-filter" = list(
      ...
      update_button = "cogTableControlsUpdateButton"
   ),
   "univar-filter" = list(
      icon = "icon-bars",
      ...
      update_button = "cogUniFilterControlsUpdateButton"
   ),
   "bivar-filter" = list(
      icon = "icon-stats",
      ...
      update_button = "cogBiFilterControlsUpdateButton"
   ),
   ...
   "sample-panels" = list(
      ...
      updateButton = "cogSampleControlsUpdateButton"
   )
)
