...
// output where the json is stored as input for the d3 histogram
...
$(document).on("click", "#d3histSubmit", function(evt) {
   ...
   if(curRange != "") {
      ...
      $(".columnFilterFrom,.columnFilterTo").each(function() { $(this).val(""); $(this).trigger("change"); })
